...
models = data_req_obj.fetch_models(dump_values, body_types=None, cities=popular_cities, makes=None,
...
response = [data_req_obj.car_info(x, dump_values) for x in top_n_cars]
